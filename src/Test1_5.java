...
public class Test1_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog alertDialog = new AlertDialog.Builder(Test1_5.this, android.R.style.Theme_Holo_NoActionBar_Fullscreen).create();
        ...
        alertDialog.setButton(AlertDialog.BUTTON_NEUTRAL, "OK",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Button btn1 = alertDialog.getButton(DialogInterface.BUTTON_NEUTRAL);
                        btn1.setTextSize(16);

                        dialog.dismiss();
                        startActivity(new Intent(Test1_5.this, MainActivity.class));
                    }
                });
...
//                toneG.startTone(ToneGenerator.TONE_CDMA_ALERT_CALL_GUARD, 30);
        ...
        new Timer().schedule(new TimerTask() {
            public void run() {
                Test1_5.this.runOnUiThread(new Runnable() {
                    public void run() {
                        ...
                        String fileName = "Test1_5" + "_" + date + ".csv";
