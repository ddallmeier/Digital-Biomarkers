...
public class Test4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog alertDialog = new AlertDialog.Builder(Test4.this, android.R.style.Theme_Holo_NoActionBar_Fullscreen).create();
        alertDialog.setMessage("Test is now finished. Great job!");
        alertDialog.setButton(AlertDialog.BUTTON_NEUTRAL, "OK",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        startActivity(new Intent(Test4.this, MainActivity.class));
                    }
                });
...
//                                    toneG.startTone(ToneGenerator.TONE_CDMA_ALERT_CALL_GUARD, 50);
                        ...
                        if (z == 2) {
                            ...
                            frequency = frequency * 1.02;
                        }

                        z = 1;
                        handler.postDelayed(this, (long) frequency);
                    }
                });
        ...
        new Timer().schedule(new TimerTask() {
            public void run() {
                Test4.this.runOnUiThread(new Runnable() {
                    public void run() {
                        ...
                        String fileName = "Test4" + "_" + date + ".csv";
